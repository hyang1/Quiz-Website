...
/**
 * Servlet implementation class IgnoreFriendServlet
 */
@WebServlet("/IgnoreFriendServlet")
public class IgnoreFriendServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IgnoreFriendServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		users.ignoreFriendRequest(senderUsername, currentUsername);
		
		request.setAttribute("message", "You ignored a request from " + senderUsername);
