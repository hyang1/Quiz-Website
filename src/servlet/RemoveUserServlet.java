...
public class RemoveUserServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String userToRemove = request.getParameter("recipient");
		User currentUser = ((User)request.getSession().getAttribute("currentUser"));
		UserManager users = (UserManager)this.getServletContext().getAttribute("UserManager");
		users.removeUser(currentUser, userToRemove);
		request.setAttribute("message", "User removed!");
		
		RequestDispatcher dispatcher = request.getRequestDispatcher("user_profile.jsp?username=" + userToRemove);
