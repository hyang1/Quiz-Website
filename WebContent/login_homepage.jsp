<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="dbconnection.UserManager, user.User"%>
...
<body background="http://wallpapercave.com/wp/TodkXxh.jpg">

<h1 align="center" style="color:white;font-size:350%">Quizard</h1>
<p align="center" style="color:white"><b>Are you smarter than your friends? Take a quiz now to find out!</b></p>
						...
						<div class="col-lg-12">
							<form id="login-form" action="LoginServlet" method="post" role="form" style="display: block;">
								...
								if (request.getAttribute("loginError") != null) {
									out.print("<p style=\"color:red\">" + request.getAttribute("loginError") + "</p>");
								}
								%>
							...
							<form id="register-form" action="RegisterServlet" method="post" role="form" style="display: none;">
								<%
									if (request.getAttribute("registerError") != null) {
										out.print("<p style=\"color:red\">" + request.getAttribute("registerError") + "</p>");
									}
								%>
